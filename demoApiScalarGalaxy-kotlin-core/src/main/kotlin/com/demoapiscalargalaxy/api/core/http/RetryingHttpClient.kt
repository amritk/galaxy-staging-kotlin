...
import com.demoapiscalargalaxy.api.core.DefaultSleeper
...
import com.demoapiscalargalaxy.api.errors.DemoApiScalarGalaxyRetryableException
...
private constructor(
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        val shouldSendRetryCount = !modifiedRequest.headers.names().contains("X-Scalar-Retry-Count")
    ...
    private fun setRetryCountHeader(request: HttpRequest, retries: Int): HttpRequest =
        request.toBuilder().replaceHeaders("X-Scalar-Retry-Count", retries.toString()).build()

    private fun idempotencyKey(): String = "scalar-kotlin-retry-${UUID.randomUUID()}"
    ...
    private fun shouldRetry(throwable: Throwable): Boolean =
        ...
        throwable is IOException ||
            throwable is DemoApiScalarGalaxyIoException ||
            throwable is DemoApiScalarGalaxyRetryableException
