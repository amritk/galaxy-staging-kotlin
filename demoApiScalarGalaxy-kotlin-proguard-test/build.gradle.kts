...
dependencies {
    testImplementation(project(":demoApiScalarGalaxy-kotlin"))
...
val mainClassName = "com.demoapiscalargalaxy.api.proguard.ProGuardCompatibilityTest"
...
val keepRules =
    files(
        "test.pro",
        "../demoApiScalarGalaxy-kotlin-core/src/main/resources/META-INF/proguard/demoApiScalarGalaxy-kotlin-core.pro",
    )
